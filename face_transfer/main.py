...
def parse_args():
    ...
    parser.add_argument('--test_img_path', type=str, default='D:/codes/python code/hyperplane-google-winter-camp/face_transfer/dataset/selfie2anime/testA/timg.jpg',
...
def main():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        if args.phase == 'test' :
            ...
            gan.test(test_image_path=test_img_path)
            print(" [*] Test finished!")
