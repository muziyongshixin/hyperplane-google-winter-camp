...
def save_images(images, size, image_path,image_size):
    return imsave(inverse_transform(images), size, image_path,image_size)

def inverse_transform(images):
    return ((images+1.) / 2) * 255.0


def imsave(images, size, path,image_size):
